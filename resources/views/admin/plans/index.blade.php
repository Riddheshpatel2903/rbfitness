...
<a href="{{ route('admin.plans.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add Plan</a>
@endsection
...
<div class="card">
    <div class="filter-container" style="margin-bottom: 2rem;">
        ...
        <span id="total-count" style="opacity:0.45;font-size:0.82rem;white-space:nowrap;">{{ $plans->count() }} total plans</span>
    </div>
    ...
    <div class="table-responsive">
        ...
        <tbody id="table-body">
            @include('admin.plans._table', ['plans' => $plans])
        </tbody>
    </table>
</div>
@endsection
...
(function () {
    ...
    const BASE_URL = '{{ route("admin.plans.index") }}';
    const DELETE_BASE = '{{ url("rbadmin/plans") }}';
    ...
    function fetchPlans(search = '') {
        ...
        .then(data => {
            ...
            totalCount.textContent = `${data.total} total plans`;
